...
public class BloomFilterBuilderTest {
  ...
  public void testBloomFilterBuilderTwoArguments() {
    ...
    assertEquals("000000000000000000000000000000000000000000000000000",
        sampleBloom.toBinaryString());
  }
  ...
  public void testBloomFilterBuilderAdd() {
    ...
    assertEquals("010000000001000000000000000110000001000000001000000",
        sampleBloom.toBinaryString());
  }
